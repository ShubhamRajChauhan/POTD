...
class Solution {
    public int earliestFinishTime(int[] landStartTime, int[] landDuration, int[] waterStartTime, int[] waterDuration) {
        int landFinish = findFinishTime(landStartTime, landDuration, waterStartTime, waterDuration);
        int waterFinish = findFinishTime(waterStartTime, waterDuration, landStartTime, landDuration);

        return Math.min(landFinish, waterFinish);
    }
